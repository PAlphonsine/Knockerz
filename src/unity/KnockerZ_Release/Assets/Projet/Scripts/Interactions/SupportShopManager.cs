...
public class SupportShopManager : MonoBehaviour
{
	...
	[SerializeField] Text airSupportToBuyText;
	// Texte de planification du nombre d'appats à acheter
	[SerializeField] Text meatSupportToBuyText;
	// Boutons de controle du nombre d'achats de soutiens aériens
	[SerializeField] Button moreAirSupportToBuyButton;
	[SerializeField] Button lessAirSupportToBuyButton;
	// Boutons de controle du nombre d'achats d'appats
	[SerializeField] Button moreMeatSupportToBuyButton;
	[SerializeField] Button lessMeatSupportToBuyButton;
	// Cout actuel
	...
	[SerializeField] SupportInventoryManager supportInventoryManager;
	...
	public void MoreAirSupportToBuy()
	{
		...
		this.currentCostText.text = "Cout actuel : " + this.currentCost + " or";
	}
	...
	public void Buy()
	{
		...
		this.meatSupportToBuy = 0;
		this.currentCost = 0;
		this.currentCostText.text = "Cout actuel : 0 or";
