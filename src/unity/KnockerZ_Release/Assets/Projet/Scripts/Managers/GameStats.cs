...
public class GameStats : MonoBehaviour
{
	...
	[SerializeField] private int pv = 20;
	// Ressources de type matériaux du joueur
	[SerializeField] private int ressourcesMat = 600;
	// Ressources de type armes du joueur
	[SerializeField] private int ressourcesWeap = 600;
	// Or du joueur
	[SerializeField] private int gold = 500;
	// Population du joueur
	[SerializeField] private int population = 20;
	// Population envoyée à la recherche de ressources
	[SerializeField] private int populationSend = 0;
