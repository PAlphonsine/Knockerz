...
public class TurretsComponentsBook : MonoBehaviour
{
	...
	[SerializeField]
	GameObject	TDModelSpe2;
	// Apreçu 3D de la tourelle D Spe2
	[SerializeField]
	GameObject	TDModelSpe1;
	// Apreçu 3D de la tourelle D Spe1
	[SerializeField]
	GameObject	THtoHModel;
	// Apreçu 3D de la tourelle CC Spe1
	[SerializeField]
	GameObject	THtoHModelSpe1;
	// Apreçu 3D de la tourelle CC Spe2
	[SerializeField]
	GameObject	THtoHModelSpe2;
	...
	public void HideInfos()
	{
		...
		if (TDModelSpe1.activeSelf)
			TDModelSpe1.SetActive (false);
		if (THtoHModelSpe1.activeSelf)
			THtoHModelSpe1.SetActive (false);
		if (TDModelSpe2.activeSelf)
			TDModelSpe2.SetActive (false);
		if (THtoHModelSpe2.activeSelf)
			THtoHModelSpe2.SetActive (false);
