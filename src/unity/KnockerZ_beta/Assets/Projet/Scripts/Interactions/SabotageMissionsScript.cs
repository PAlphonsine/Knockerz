...
public class SabotageMissionsScript : MonoBehaviour
{
	...
	[SerializeField]
	FinalSabotageScript finalSabotageScript;
	// Texte informant le joueur du montant de son compte d'or
	[SerializeField]
	Text goldAmmountText;
	...
	[SerializeField]
	InputField goldInvestmentInputField;
	// Bouton valider
	[SerializeField]
	...
	public void GoldInvestmentChanged()
	{
		...
		if (this.goldInvestment > GameStats.Instance.Gold)
		{
			...
			StartCoroutine(this.GoldAmmountExceed());
		}
		else
		{
	...
	public IEnumerator GoldAmmountExceed()
	{
